To format the `README.rst` as you requested, with bold headings marked by the automatic "Büroklammer" (code format in reStructuredText), here's how it would look:
