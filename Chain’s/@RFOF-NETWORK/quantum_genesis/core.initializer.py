...
class RFOFBlockchain:
    ...
    def create_arc_genesis_reactor_block(self):
        if not self.genesis_created:
            ...
            arc_reactor_block = {
                ...
                "extra_features": self.initialize_arc_features()
            }
    ...
    def create_genesis_block(self):
        genesis_block = {
            ...
            "extra_features": self.initialize_genesis_features()
        }
    ...
    def generate_virtual_blocks(self):
        virtual_blocks = []
        for i in range(1, 1000000001):  # Reduzierte Anzahl für Beispielzwecke
...
class PRAI:
    ...
    def execute_command(self, command):
        if command == "create_block":
            ...
            from_address = blockchain.coin_master_address
            return blockchain.create_block(transaction, from_address)
        elif command == "create_arc_genesis_reactor_block":
            blockchain = RFOFBlockchain()
            return blockchain.create_arc_genesis_reactor_block()
...
if __name__ == "__main__":
    ...
    prai = PRAI()
    print(prai.receive_command("create_block"))
    print(prai.receive_command("create_arc_genesis_reactor_block"))
